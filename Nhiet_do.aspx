<%@ Page Title="" Language="C#" MasterPageFile="~/Page.Master" AutoEventWireup="true" CodeBehind="Nhiet_do.aspx.cs" Inherits="MET_Station.Nhiet_do" %>
                ...
                <div id="panel-1" class="panel panel-default">
                    <div class="panel-heading">
                        <span class="title elipsis">
                            <strong>NHIỆT ĐỘ (ĐỘ C) - CB 001</strong> <!-- panel title -->
                        </span>
                    ...
                    <div class="panel-body">
                        ...
                        <asp:Literal ID="Literal_Hienthigiatricambien1" runat="server"></asp:Literal>
                    </div>
                    <!-- /panel content -->
