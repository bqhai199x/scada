<%@ Page Title="" Language="C#" MasterPageFile="~/Page.Master" AutoEventWireup="true" CodeBehind="Toc_do_gio.aspx.cs" Inherits="MET_Station.Toc_do_gio" %>
                ...
                <div id="panel-1" class="panel panel-default">
                    <div class="panel-heading">
                        <span class="title elipsis">
                            <strong>TỐC ĐỘ GIÓ (m/s) - CB 003</strong> <!-- panel title -->
                        </span>
                    ...
                    <div class="panel-body">
                        ...
                        <asp:Literal ID="Literal_Hienthigiatricambien3" runat="server"></asp:Literal>
                    </div>
                    <!-- /panel content -->
