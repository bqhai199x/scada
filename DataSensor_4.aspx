<%@ Page Title="" Language="C#" MasterPageFile="~/Page.Master" AutoEventWireup="true" CodeBehind="DataSensor_4.aspx.cs" Inherits="MET_Station.DataSensor_4" %>
                ...
                <div id="panel-1" class="panel panel-default">
                    <div class="panel-heading">
                        <span class="title elipsis">
                            <strong>CẢM BIẾN 4 (mm) - CB 004</strong> <!-- panel title -->
                        </span>
                    ...
                    <div class="panel-body">
                        ...
                        <asp:Literal ID="Literal_Hienthigiatricambien4" runat="server"></asp:Literal>
                    </div>
                    <!-- /panel content -->
